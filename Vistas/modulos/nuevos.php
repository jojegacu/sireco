    ...
    <div class="modal-content">
      ...
      <div class="modal-body text-center">
        ...
        <form id="formActualizarCV" enctype="multipart/form-data">
          <input type="hidden" name="idActualizarCv" id="idActualizarCv">
          <div class="form-group text-left">
            <label for="nuevoCv">Actualizar CV (PDF):</label>
            <input type="file" name="nuevoCv" id="nuevoCv" accept="application/pdf" class="form-control" required>
          </div>
          <button type="submit" class="btn btn-success">
            <i class="fa fa-upload"></i> Subir nuevo CV
          </button>
        </form>
      </div>
    </div>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <!-- 🔹 SECCIÓN 3: NUEVA VACANTE A SELECCIONAR -->
        <div class="mt-4">
          <h5><strong>Seleccionar Nueva Vacante</strong></h5>
          <hr>
          <div class="form-group">
            <input type="text" id="filtroVacante" class="form-control" placeholder="Filtrar por clave o CP...">
          </div>
          <div class="table-responsive" style="max-height: 300px; overflow-y: auto;">
            <table class="table table-bordered table-hover" id="tablaVacantes">
              ...
              <tbody>
                <!-- Aquí se cargan dinámicamente las vacantes -->
              </tbody>
            </table>
          </div>
        </div>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-success" id="btnActualizarVacante">Actualizar</button>
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
      </div>
    </div>
  </div>

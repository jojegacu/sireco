				...
				<div class="box-body">
					<div class="row">
						<div class="col-lg-6">
							<div class="form-group">
								<h2>NOMBRE(S)</h2>
								<input class="form-control input-lg" type="text" onkeyup="this.value = this.value.toUpperCase();" name="nombre" value="<?php echo $aspirante['nombre'] ?? ''; ?>" required readonly>
							</div>
						</div>
						<div class="col-lg-6">
							<div class="form-group">
								<h2>APELLIDO PATERNO</h2>
								<input class="form-control input-lg" type="text" onkeyup="this.value = this.value.toUpperCase();" name="apPaterno" value="<?php echo $aspirante['apPaterno'] ?? ''; ?>" required readonly>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-lg-6">
							<div class="form-group">
								...
								<input class="form-control input-lg" type="text" onkeyup="this.value = this.value.toUpperCase();" name="apMaterno" value="<?php echo $aspirante['apMaterno'] ?? ''; ?>" required readonly>
							</div>
						</div>
						<div class="col-lg-6">
							<div class="form-group">
								<h2>FECHA DE NACIMIENTO</h2>
								<input class="form-control input-lg" type="date" name="fechaNacimiento" value="<?php echo $aspirante['fechaNacimiento'] ?? ''; ?>" required readonly>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-lg-6">
							<div class="form-group">
								<h2>CALLE/NUMERO</h2>
								<input class="form-control input-lg" type="text" name="calleNo" value="<?php echo $aspirante['calleNo'] ?? ''; ?>" required readonly>
							</div>
						</div>
						<div class="col-lg-6">
							<div class="form-group">
								...
								<input class="form-control input-lg" type="number" name="telefonoCel" id="telefonoCel" minlength="10" maxlength="10"
									...
									oninput="if(this.value.length > 10) this.value = this.value.slice(0,10);" required readonly>
							</div>
						</div>
					</div>
					...
					<div class="form-group" align="center">
						...
						<a href="<?php echo $base_url; ?>checkManager" class="btn btn-danger btn-flat">CERRAR</a>
					</div>
				</div>
			</form>
		</div>

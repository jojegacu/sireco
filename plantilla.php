...
// URL base (cambia esta línea si vas a hosting)
//$base_url = "http://localhost/sireco/";
//$base_url = "https://sireco.byethost11.com/"; // para hosting
$protocolo = isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? "https" : "http";
$host = $_SERVER['HTTP_HOST'];
$base_url = $protocolo . "://" . $host . "/sireco/";
?>
